...
namespace Api.Entegration
{
    public class Executer
    {
        //[STAThread]
        public Executer(string phone, string number)
        {
            try
            {
                // Kullanici adi, parola ve Originator kullanilarak bir sms paketi olusturulur.

                SMSPaketi smspak = new SMSPaketi("sporjoy", "Sporjoy34*", "SPORJOY");
